...
class NativeTemplateStyle {
    ...
    var primaryTextBackgroundColor = ColorDrawable(Color.BLACK)
        private set
    ...
    var secondaryTextBackgroundColor = ColorDrawable(Color.BLACK)
        private set
    ...
    var tertiaryTextBackgroundColor = ColorDrawable(Color.BLACK)
        private set
